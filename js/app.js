...
var Model = [
      {
        ...
        location: {lat: 36.144060, lng: -86.742024}
      },
      {
        title: 'Monell\'s Dining & Catering',
        location: {lat: 36.175806, lng: -86.790297}
      },
      {
        title: 'Etch Restaurant',
        location: {lat: 36.159187, lng: -86.775021}
      },
      {
        title: 'Skull\'s Rainbow Room',
        location: {lat: 36.164496, lng: -86.779043}
      },
      {
        title: 'Mas Tacos',
        location: {lat: 36.184765, lng: -86.754677}
      },
      {
        title: 'Mission BBQ',
        location: {lat: 36.2045447, lng: -86.691572}
      },
      {
        title: 'Hattie B\'s Hot Chicken',
        location: {lat: 36.151475, lng: -86.796620}
      },
      {
        title: 'Kayne Prime',
        location: {lat: 36.155684, lng: -86.785955}
      },
      {
        title: 'Pancake Pantry',
        location: {lat: 36.137024, lng: -86.800537}
      }        
];
...
var ViewModel = function() {
    ...
    var initMap = function() {
      ...
      for (var i = 0; i < Model.length; i++) {
        ...
        eventHandling(marker);
      }

      map.fitBounds(bounds);

      function eventHandling (marker) {
